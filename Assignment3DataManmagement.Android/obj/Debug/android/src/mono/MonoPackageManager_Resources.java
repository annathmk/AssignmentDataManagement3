...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Assignment3DataManmagement.Android.dll" comes first in this list. */
		"Assignment3DataManmagement.Android.dll",
		"Assignment3DataManmagement.dll",
		"FormsViewGroup.dll",
		"GraphQL.Client.dll",
		"GraphQL.Common.dll",
		"Newtonsoft.Json.dll",
